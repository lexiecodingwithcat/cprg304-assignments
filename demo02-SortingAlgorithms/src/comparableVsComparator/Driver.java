...
public class Driver
{
	...
	{
		//when do not specify the size of the arrayList, the default capacity is 10
		...
		//the list passed in should be comparable objects
		...
		//the sort will only sort students by grades
		...
		// lambdas can be used for Comparator because equals() has a default
		// implementation
		...
		{
			System.out.println(
					"\t" + studsArray[i].getName() + " " + studsArray[i].getID() + " " + studsArray[i].getGrade() );
		}

		// example of sorting using a custom sorting algorithm (using name - comparator)
		...
		// example of sorting using a custom sorting algorithm (using ID - comparable)
		System.out.println( "Sort by ID via Array with my own algorithm: " );
